      ...
      <div class="collapse navbar-collapse" id="navbar">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" id="dropdownAdmin" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Admin</a>
          ...
          <li class="nav-item">
            <a class="nav-link" href="panier.php"><i class="fas fa-shopping-basket"></i></a>
          </li>
          <?php if(!$logged) { ?>
          <li class="nav-item">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="modificationDesProduits.php">Vendre</a>
          </li>
          <li class="nav-item">
